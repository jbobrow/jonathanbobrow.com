...
Blinks was built the same way: lots of prototyping, getting it into hands early, and iterating until it felt right. There's an old saying in game design, _a late game is just late, but a bad game is bad forever_. We took that seriously, but balanced it with our own philosophy: open up early, build with your community. 
